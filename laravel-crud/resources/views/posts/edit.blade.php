        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="height:35px" name="genre" placeholder="genre" value="{{$post->genre}}">{{ $post->description }}</textarea>
                    @error('description')
                     <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>movie Image:</strong>
                 <input type="file" name="image" class="form-control" placeholder="Post Title" value="{{ asset('images/' . $post->image) }}">
                @error('image')
                  <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
               @enderror
            </div>
            <div class="form-group">
              ...
              <img src="public/images . {{$post->image}}" height="200" width="200" alt="{{$post->image}}" value="" />
            </div>
        </div>
